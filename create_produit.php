...
if (isset($_POST['bouton'])) {
  ...
  $query = $pdo->prepare('INSERT INTO `produits`(`id`,`nom`, `image`, `description`, `date_sortie`, `categorie_id`) VALUES (?,?,?,?,?,?)');
  $query->execute([$id, $nom, $image, $description, $date_sortie, $categorie]);
}
